...
function Header() {
  ...
  const handleMapClick = () => {
    ...
    setIsPhoneOpen(false); // Закрываем телефонный блок, если открыт
  };

  const handlePhoneClick = () => {
    setIsPhoneOpen(!isPhoneOpen);
    setIsMapOpen(false); // Закрываем блок карты, если открыт
  };

  return (
    <header className="header">
      <button className="header__map" onClick={handleMapClick}>
        <svg
          className="header__map-svg"
          width="19"
          height="18"
          viewBox="0 0 19 18"
          fill="none"
      ...
      {isMapOpen ? (
        <div className="map-content">
          <p className="map-content-title">
            Адрес:{" "}
            <span className="map-content-span">
        ...
        <div className="phone-content">
          <div className="phone-content-num">8(800)900 00 00</div>
          <button className="phone-content-button">Оставить заявку</button>
        </div>
      ) : (
      ...
      <button className="header__phone" onClick={handlePhoneClick}>
        <svg
          className="header__phone-svg"
          width="19"
          height="18"
          viewBox="0 0 19 18"
          fill="none"
